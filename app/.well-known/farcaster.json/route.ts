...
export async function GET() {
  ...
  const description = process.env.NEXT_PUBLIC_MINIAPP_DESCRIPTION || "Post to Farcaster and Twitter with Base payments"
  const website = process.env.NEXT_PUBLIC_URL || "http://localhost:3000"
